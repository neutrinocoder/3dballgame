...
export const officialLevels: CustomLevel[] = [
  {
    ...
    blocks: [
      ...
      { id: uuidv4(), position: [0, -1, -12], size: [8, 1, 8], type: 'platform', color: '#cbd5e1' }, // Gap = 3
      { id: uuidv4(), position: [0, -3, -25], size: [6, 1, 6], type: 'platform', color: '#cbd5e1' }, // Drop 2 units, Gap = 6

      // 3. MUD SECTION
      { id: uuidv4(), position: [0, -5, -35], size: [8, 1, 8], type: 'mud', color: '#78350f' },
      { id: uuidv4(), position: [0, -5, -43], size: [4, 1, 4], type: 'mud', color: '#78350f' }, // Mud gap 2
      { id: uuidv4(), position: [0, -5, -50], size: [6, 1, 6], type: 'platform', color: '#cbd5e1' }, // Mud to platform gap 3
      ...
      { id: uuidv4(), position: [-25, 5, -125], size: [2, 50, 100], type: 'wall', color: '#94a3b8' }, // Left Boundary
      { id: uuidv4(), position: [25, 5, -125], size: [2, 50, 100], type: 'wall', color: '#94a3b8' },  // Right Boundary
      { id: uuidv4(), position: [0, 30, -125], size: [50, 2, 100], type: 'wall', color: '#94a3b8' },  // Ceiling Boundary
