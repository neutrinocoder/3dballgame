...
export function Background({ theme = 'glow' }: BackgroundProps) {
    ...
    return (
      <>
        ...
        <EffectComposer disableNormalPass multisampling={0}>
          <Bloom luminanceThreshold={2.0} intensity={0.5} />
        </EffectComposer>
      </>
    );
  }
  ...
  if (theme === 'neon') {
    return (
      <>
        ...
        <Sparkles count={150} scale={100} size={3} speed={0.8} opacity={0.5} color="#00ffff" />
  ...
  if (theme === 'dark') {
    return (
      <>
        ...
        <EffectComposer disableNormalPass multisampling={0}>
          <Bloom luminanceThreshold={1.5} intensity={0.5} />
        </EffectComposer>
      </>
    );
  }
  ...
  if (theme === 'space') {
    return (
      <>
        ...
        <Environment preset="night" />
        <EffectComposer disableNormalPass multisampling={0}>
          <Bloom luminanceThreshold={1.0} intensity={1.5} />
        </EffectComposer>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <Sparkles count={150} scale={100} size={2} speed={0.4} opacity={0.3} color="#a855f7" />
      <Environment preset="night" />
      <EffectComposer disableNormalPass multisampling={0}>
        <Bloom luminanceThreshold={1.0} intensity={1.5} />
      </EffectComposer>
